<style>
    ...
    .mir-table, .mir-table th, .mir-table td {
        border: 1px solid black;
    }
    .mir-table th, .mir-table td {
        padding: 3px 5px;
...
<div class="page-mir" style="{{ $loop->first ? 'page-break-before: auto;' : 'page-break-before: always;' }}">
    @foreach($chunk as $index => $record)
    <div class="mir-container">
        <!-- Header Block -->
        <table class="mir-table header-table">
            <tr>
        ...
        <!-- Items Block -->
        <table class="mir-table items-table">
            <thead>
                <tr class="text-center font-bold" style="background-color: transparent;">
                    <td style="width: 28%; font-weight: bold;">Description</td>
                    <td style="width: 12%; font-weight: bold;">Stock No.</td>
                    <td style="width: 12%; font-weight: bold;">Lokasi</td>
                    <td style="width: 8%; font-weight: bold;">Diminta</td>
                    <td style="width: 10%; font-weight: bold;">Diserahkan</td>
                    <td style="width: 8%; font-weight: bold;">BOH</td>
                    <td style="width: 7%; font-weight: bold;">UOI</td>
                    <td style="width: 15%; font-weight: bold;">Kode Biaya</td>
                </tr>
            </thead>
            <tbody>
                @php
        ...
        <table class="mir-table footer-table">
            <tr class="font-bold">
                ...
                <td style="width: 20%; font-weight: bold;">Diketahui</td>
                <td style="width: 20%; font-weight: bold;">Diserahkan</td>
