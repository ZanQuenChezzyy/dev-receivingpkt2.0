<div class="min-h-screen bg-slate-50 dark:bg-[#031525] transition-colors duration-500 pt-28 pb-24 font-sans relative overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        @if($showSuccessMessage)
            <div x-data x-init="window.scrollTo({ top: 0, behavior: 'smooth' })" class="bg-green-500/10 border border-green-500/20 backdrop-blur-xl rounded-3xl p-6 sm:p-8 mb-12 flex items-start gap-5 animate-fade-in-up shadow-lg shadow-green-500/5">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" wire:model.live.debounce.300ms="diminta_oleh" class="glass-input pl-12 w-full text-slate-900 dark:text-white py-4 placeholder-slate-400" required placeholder="Contoh: John Doe">
                                </div>
                            ...
                            <!-- NPK -->
                            <div>
                                <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2.5">NPK <span class="text-[#F47920]">*</span></label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                        <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path></svg>
                                    </div>
                                    <input type="text" wire:model="npk" class="glass-input pl-12 w-full text-slate-900 dark:text-white py-4 placeholder-slate-400" required placeholder="Contoh: 123456">
                                </div>
                                @error('npk') <span class="text-red-500 text-xs font-semibold mt-2 block">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" wire:model="no_hp" class="glass-input pl-12 w-full text-slate-900 dark:text-white py-4 placeholder-slate-400" required placeholder="0812...">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" wire:model="departemen" class="glass-input pl-12 w-full text-slate-900 dark:text-white py-4 placeholder-slate-400" required placeholder="Nama Departemen">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" wire:model="bagian" class="glass-input pl-12 w-full text-slate-900 dark:text-white py-4 placeholder-slate-400" required placeholder="Sub-bagian">
                                </div>
                    ...
                    <div class="glass-panel p-6 sm:p-8 lg:p-10 hover:-translate-y-0.5">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            <div class="min-w-0">
                                ...
                                <div class="relative min-w-0">
                                    ...
                                    <input type="date" wire:model="tanggal" class="glass-input appearance-none block box-border min-w-0 max-w-full pl-12 w-full text-slate-900 dark:text-white py-4 [&::-webkit-calendar-picker-indicator]:hidden" required>
                                </div>
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6 mb-8">
                            <div>
                                ...
                                <input type="text" wire:model="no_reservasi" placeholder="Misal: RES-12345" class="glass-input w-full text-slate-900 dark:text-white py-3.5 px-4 placeholder-slate-400">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">No. JOR/WO</label>
                                <input type="text" wire:model="no_jor_wo" placeholder="Misal: JOR-9876" class="glass-input w-full text-slate-900 dark:text-white py-3.5 px-4 placeholder-slate-400">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">No. Alat</label>
                                <input type="text" wire:model="no_alat" placeholder="Misal: ALT-001" class="glass-input w-full text-slate-900 dark:text-white py-3.5 px-4 placeholder-slate-400">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">Kode Biaya</label>
                                <input type="text" wire:model="kode_biaya" placeholder="Misal: CC-500" class="glass-input w-full text-slate-900 dark:text-white py-3.5 px-4 placeholder-slate-400">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea wire:model="digunakan_untuk" rows="3" class="glass-input w-full text-slate-900 dark:text-white py-4 px-5 placeholder-slate-400" required placeholder="Jelaskan secara singkat peruntukan material ini..."></textarea>
            ...
            <div class="relative z-10 group/step animate-fade-in-up mb-12">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <div class="md:pl-0 sm:self-center self-start pl-[5.5rem]">
                        ...
                        <button type="button" wire:click="addDetail" class="glass-btn flex items-center gap-2.5 px-5 py-3 bg-slate-50 dark:bg-slate-800 rounded-2xl text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 font-bold transition-all shadow-sm group">
                        ...
                        <div class="relative glass-panel p-6 sm:p-8 group/card overflow-hidden">
                            ...
                            <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
                                ...
                                <div class="xl:col-span-3">
                                    <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">Pilih Item <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <select wire:model.live="details.{{ $index }}.delivery_order_receipt_detail_id" class="glass-input w-full appearance-none text-slate-900 dark:text-white px-5 py-4 font-semibold" required>
                                ...
                                <div class="xl:col-span-6">
                                    <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">Deskripsi</label>
                                    <input type="text" value="{{ $details[$index]['description'] }}" class="w-full bg-slate-100/50 dark:bg-black/40 border border-slate-200/50 dark:border-white/5 text-slate-500 dark:text-slate-400 rounded-2xl px-5 py-4 cursor-not-allowed font-medium" readonly placeholder="Deskripsi terisi otomatis...">
                                </div>

                                <!-- Stock No -->
                                <div class="xl:col-span-3">
                                    <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 mb-2.5 uppercase tracking-wider">Stock No.</label>
                                    <input type="text" value="{{ $details[$index]['stock_no'] }}" class="w-full bg-slate-100/50 dark:bg-black/40 border border-slate-200/50 dark:border-white/5 text-slate-500 dark:text-slate-400 rounded-2xl px-5 py-4 cursor-not-allowed font-semibold tracking-wider text-center" readonly placeholder="-">
                                </div>
            ...
            <div class="relative z-10 mb-12 group/step animate-fade-in-up" style="animation-delay: 100ms;">
                ...
                <div class="md:pl-[8.5rem]">
                    ...
                    <div class="space-y-3">
                        ...
                        <p class="text-xs text-slate-500 mb-2">Tanda tangan yang akan dicantumkan pada kolom Diminta dan Diterima.</p>
                        
                        <x-signature-pad wire:model="diminta_signature" id="diminta_signature" placeholder="Goreskan tanda tangan Anda di sini..." />
                        @error('diminta_signature') <span class="text-red-500 text-xs font-bold">{{ $message }}</span> @enderror
                    </div>

                    <!-- Tanda Tangan ISTEK (Muncul Jika requiresIstekSignature = true) -->
                    @if($requiresIstekSignature)
                    <div class="space-y-3 p-5 rounded-2xl border-2 border-orange-200 dark:border-orange-900/50 bg-orange-50/50 dark:bg-orange-900/10">
                        ...
                        <x-signature-pad wire:model="disetujui_signature" id="disetujui_signature" placeholder="Goreskan tanda tangan ISTEK di sini..." />
