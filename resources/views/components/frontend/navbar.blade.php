<nav x-data="{ mobileMenuOpen: false }"
        ...
        <div x-show="mobileMenuOpen" style="display: none;"
            ...
            <div class="px-5 py-6 flex flex-col gap-4">
                ...
                <a href="{{ route('frontend.mir.create') }}" wire:navigate class="border border-slate-200 dark:border-white/10 rounded-2xl bg-slate-50 dark:bg-white/5 shadow-sm flex items-center gap-2 px-4 py-3.5 text-sm font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-white/10 transition-colors">
