...
### Modul 5: Transmittal Gudang untuk material dengan MRP TYPE V1

Modul ini khusus merekam pergerakan fisik pengambilan barang (Issue) untuk material dengan MRP TYPE V1 ke Lokasi Gudang penyimpanan seperti (Gudang Bulk Material, Gudang Chemical & Karung, Gudang Ex KPA dan Lainnya), biasanya pembuatan transmittal gudang dilakukan dengan scan kode 105 yang ada di Goods Receipt Slip (GRS) yang telah di cetak. jadi kalo dulu saya sudah buat sistem seperti masukkan tanggal kirim -> Scan Kode 105(GRS) Item yang tersambung ke GRS tersebut muncul otomatis -> Pilih Lokasi Gudang (biasanya lokasinya ketahuan dari GRS Fisik yang dicetak) -> PIC langsung terpilih otomatis berdasarkan Lokasi nya (Misal Pilih Gudang Bulk material PIC otomatis = user dengan nama Zaki) -> setelah itu buat, karena sekarang sudah digital dan GRS sudah tidak dicetak lagi melainkan melalui surat dof, maka saya bingung dalam menentukan lokasi pengeiriman item ini ke gudang mana, serta scan kode 105 nya tidak bisa.